...
def main(args):
    ...
    pickle.dump(image_shapes_CT_train, open(args.output_CT_filename + "_train.p", 'wb'))
    pickle.dump(image_shapes_CT_val, open(args.output_CT_filename + "_validation.p", 'wb'))
    ...
    if args.CBCT:
        ...
        pickle.dump(image_shapes_CBCT_train, open(args.output_CBCT_filename + "_train.p", 'wb'))
        pickle.dump(image_shapes_CBCT_val, open(args.output_CBCT_filename + "_validation.p", 'wb'))
...
def parse_args():
    ...
    parser.add_argument("-output_CT_filename", required=False, default="CT_shapes")
    parser.add_argument("-output_CBCT_filename", required=False, default="CBCT_shapes")

    parser.add_argument("-CBCT", required=False, default=False, action="store_true")
    ...
    if args.CBCT and (args.CBCT_filename is None or args.output_CBCT_filename is None):
        parser.error("input and output file for CBCT need to be given in case of -CBCT")
