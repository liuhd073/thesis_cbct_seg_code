...
def train(args):
    ...
    for i, (X, Y) in enumerate(dl):
        ...
        writer.add_image("images_true/X", X[:,:,10:11,:,:].squeeze(), i, dataformats="HW")
        ...
        writer.add_image("images/X", X[:,:,10:11,:,:].squeeze(), i, dataformats="HW")
    ...
    # write_image(img, "testing/image.nii")
    write_image(seg_bladder, "testing/seg_bladder.nrrd", metadata=metadata)
    write_image(seg_cervix_uterus, "testing/seg_cervix_uterus.nrrd", metadata=metadata)
